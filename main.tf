...
provider "google" {
  ...
  region      = "us-central3"   # Replace with your desired region
}

# Define the Kubernetes Engine cluster
resource "google_container_cluster" "my_cluster" {
  name               = "my-gke-cluster"
  location           = "us-central3"   # Replace with your desired region
...
resource "google_compute_instance" "cluster_worker_tags" {
  ...
  zone         = "us-central3-c"          # Replace with your desired zone
  machine_type = "n1-standard-1"          # Replace with your desired machine type
